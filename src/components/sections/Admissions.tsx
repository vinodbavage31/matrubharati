...
import { Phone, Mail, MapPin, CheckCircle, ArrowRight, Clock, Calendar, Users } from "lucide-react";
import { ScrollAnimation } from "@/hooks/useScrollAnimation";

const admissionSteps = [
  { step: "01", title: "Submit Enquiry", description: "Fill the form or call us" },
  { step: "02", title: "Campus Visit", description: "Tour our facilities" },
  { step: "03", title: "Documentation", description: "Complete admission formalities" },
  { step: "04", title: "Welcome", description: "Join the Matru Bharati family" }
];
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-r from-secondary via-secondary to-accent rounded-2xl p-8 md:p-12 mb-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 text-lg mb-6 max-w-2xl mx-auto">
                ...
                Special batch for competitive exam preparation starting soon.
              </p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {admissionSteps.map((item, index) => (
                <div key={item.step} className="text-center p-6 bg-muted rounded-xl border border-border relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <ScrollAnimation animation="slide-left">
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                ...
                campus visits, or any questions about our programs. Our admissions team is ready to assist you.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-muted rounded-xl p-4 text-center border border-border">
                  ...
                  <span className="text-sm font-medium text-foreground">Campus Visit</span>
                  <p className="text-xs text-muted-foreground">By Appointment</p>
                </div>
                <div className="bg-muted rounded-xl p-4 text-center border border-border">
                  <Users className="h-6 w-6 text-secondary mx-auto mb-2" />
                  <span className="text-sm font-medium text-foreground">Counseling</span>
                  <p className="text-xs text-muted-foreground">Free Session</p>
                </div>
              </div>
          ...
          <ScrollAnimation animation="slide-right">
            <div className="bg-card rounded-2xl p-8 shadow-elevated border border-border sticky top-40">
